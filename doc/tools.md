...
This is the current list of external tools with the source and and command references. I used [Kevin Suttle's documentation](https://github.com/kevinSuttle/macOS-Defaults) as my main source.
